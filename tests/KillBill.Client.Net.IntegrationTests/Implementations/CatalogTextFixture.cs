...
namespace KillBill.Client.Net.IntegrationTests.Implementations
{
    ...
    public class CatalogTextFixture : BaseTestFixture
    {
        ...
        public async Task When_UploadingCatalogXml_Then_ItIsSavedCorrectly()
        {
            // arrange
            ...
            // act
            await Client.UploadCatalogXml(catalogXml, RequestOptions);
        }

        [Test]
        public async Task When_GettingCatalogJson_Then_ItIsReturnedCorrectly()
        {
            // arrange / act
            var result = await Client.GetCatalogJson(RequestOptions);
        ...
        [Test]
        public async Task Given_Date_When_GettingCatalogJson_Then_ItIsReturnedCorrectly()
        {
            // arrange 
            var date = new DateTime(2018, 01, 01);

            // act
            var result = await Client.GetCatalogJson(RequestOptions, date);
